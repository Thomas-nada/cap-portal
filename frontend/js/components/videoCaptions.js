...
const TEXTS = {
    en: {
        ...
        c2a: 'Step 2: once signed in, click “New CAP” to open the proposal form, choose CAP, pick a category, and give your proposal a title.',
        ...
        c2e: 'Both selections are now saved to the proposal. Click “Back to Proposal” to continue.',
    ...
    ja: {
        ...
        c2e: '両方の選択が提案に保存されました。「Back to Proposal」をクリックして続行します。',
    ...
    es: {
        ...
        c2e: 'Ambas selecciones quedan guardadas en la propuesta. Haz clic en «Back to Proposal» para continuar.',
    ...
    de: {
        ...
        c2e: 'Beide Auswahlen sind nun im Vorschlag gespeichert. Klicke auf „Back to Proposal“, um fortzufahren.',
    ...
    vi: {
        ...
        c2e: 'Cả hai lựa chọn đã được lưu vào đề xuất. Nhấp «Back to Proposal» để tiếp tục.',
    ...
    id: {
        ...
        c2a: 'Langkah 2: setelah masuk, klik «New CAP» untuk membuka formulir proposal, pilih CAP, pilih kategori, dan beri judul proposal Anda.',
        ...
        c2e: 'Kedua pilihan kini tersimpan dalam proposal. Klik «Back to Proposal» untuk melanjutkan.',
    ...
    pt: {
        ...
        c2e: 'As duas seleções estão salvas na proposta. Clique em «Back to Proposal» para continuar.',
    ...
    fr: {
        ...
        c2e: 'Les deux sélections sont enregistrées dans la proposition. Cliquez sur « Back to Proposal » pour continuer.',
    ...
    ko: {
        ...
        c2e: '두 선택 모두 제안서에 저장되었습니다. “Back to Proposal”를 클릭해 계속 진행하세요.',
    ...
    zh: {
        ...
        c2e: '两个选择都已保存到提案中。点击“Back to Proposal”继续。',
