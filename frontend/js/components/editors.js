...
function personCard({ person, user, isAdmin, onRemove, accentFrom, accentTo, icon }) {
    ...
    return `
 <div class="bg-white/80 rounded-[2.5rem] border border-slate-100 shadow-sm p-8 flex items-center gap-5 group">
...
export function renderEditors(state) {
 ...
 <div class="bg-blue-50 border border-blue-200 rounded-[3rem] p-12 text-center mb-8">
 <div class="w-16 h-16 bg-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg">
 <i data-lucide="shield-check" class="w-8 h-8 text-white"></i>
        </div>
 <h2 class="text-2xl font-black italic tracking-tighter text-slate-900 uppercase mb-3">No Admins Yet</h2>
 ...
 <div class="bg-white/80 rounded-[3rem] border border-slate-100 shadow-sm p-10 mb-6">
 <h3 class="text-base font-black italic tracking-tighter text-slate-900 uppercase mb-5">Add Admin</h3>
 ...
 <div class="text-center py-10 border-2 border-dashed border-slate-200 rounded-2xl mb-4">
 ...
 <div class="bg-white/80 rounded-[3rem] border border-slate-100 shadow-sm p-10 mb-6">
 <h3 class="text-base font-black italic tracking-tighter text-slate-900 uppercase mb-5">Add Editor</h3>
 <div class="flex flex-col sm:flex-row gap-4">
