    ...
    <div class="max-w-6xl mx-auto pb-20 fade-in text-left">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-[3rem] border border-slate-100 dark:border-slate-800 shadow-sm p-10">
                ...
                <h2 class="text-2xl font-black italic tracking-tighter text-slate-900 dark:text-white uppercase mb-4">Using the Portal</h2>
                <p class="text-slate-500 mb-6">Learn to use the CAP Portal effectively</p>
                <div class="space-y-3">
                    <button onclick="window.openGuide('connecting-your-wallet')" class="w-full p-4 rounded-2xl border-2 border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white text-sm font-bold text-left hover:-translate-y-0.5 transition-all">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-[3rem] border border-slate-100 dark:border-slate-800 shadow-sm p-10">
                ...
                <div class="space-y-3">
                    <button onclick="window.openGuide('public-api')" class="w-full p-4 rounded-2xl border-2 border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white text-sm font-bold text-left hover:-translate-y-0.5 transition-all">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-[3rem] border border-slate-100 dark:border-slate-800 shadow-sm p-10 md:col-span-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ${[
                        ...
                        { label: 'Do I need a Cardano wallet?', slug: 'faq-do-i-need-a-wallet' },
